    ...
    >
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          {/* Brand */}
          <div>
            <h3 className="font-heading text-xl font-800 mb-4">
              📚 EscolarShop
            </h3>
            <p className="text-primary-foreground/70 text-sm leading-relaxed">
              Tu librería de confianza para la vuelta a clases. Calidad, precio
              y estilo en un solo lugar.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm text-primary-foreground/70">
              <span className="flex items-center gap-2">
                <Mail className="w-4 h-4" /> hola@escolarshop.com
              </span>
              <span className="flex items-center gap-2">
                <MapPin className="w-4 h-4" /> Av. Corrientes 1234, CABA
              </span>
              <span className="flex items-center gap-2">
                <Clock className="w-4 h-4" /> Lun a Sáb 9:00 - 19:00
              </span>
            </div>
          </div>
